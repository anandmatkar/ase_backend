                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            Subject: New Manager Verification Approval Request
                                            <br>
                                            Please find below the details of the new manager for your verification and approval: <br>
                                            <br/>
                                            Please go to Admin Dashboard and Verify manager<br/>
                                            
                                            Name: ${data.name} <br/>
                                            Email Address: ${data.email_address} <br/>
                                            Phone Number: ${data.phone_number} <br/>
                                            Company: ${data.company} <br/>
                                            Position: ${data.position} <br/>
                                            Created At: ${data.created_at.toLocaleString()} <br/>
